...
ent-NinjaKillRandomPersonObjective = Убийство
    .desc = Клану нужно чтобы вы избавились от определённого члена экипажа станции. Сделайте это скрытно.
ent-NinjaProtectPersonObjective = Защита
    .desc = Клан требует, чтобы один из членов экипажа станции остался жив. Присмотрите за ним, он не должен умереть.
